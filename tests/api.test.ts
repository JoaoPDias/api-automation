...
describe("API Validations", () => {
  describe("/users", () => {
    ...
    test("should create an user", async () => {
        ...
        const response = await request.post("/users").send(PostUserRequestBuilder.new().build());
      ...
      test.each<Number>([0,3])("should get list of users of the page %i with response time less than 1 second", async (page:number) => {
